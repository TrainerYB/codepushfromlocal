...
const NuGetConfigHelper2_1 = require("packaging-common/nuget/NuGetConfigHelper2");
...
const util_2 = require("packaging-common/util");
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            if (selectOrConfig === "select") {
                ...
                if (includeNuGetOrg) {
                    const nuGetSource = nuGetVersion.productVersion.a < 3
