...
function updateSettingsFileAsRequired(settingsFile, isParallelRun, tiaConfig, vsVersion, videoCollector, overrideParametersString, isDistributedRun, codeCoverageToolsInstallerFlow) {
...
function updateRunSettingsWithCodeCoverageDetails(result, codeCoverageNode, settingsFile) {
...
function updateSettingsWithParameters(result, overrideParametersString) {
...
function setUseVerifiableInstrumentationToFalse(dataCollectorArray) {
    for (const node of dataCollectorArray) {
