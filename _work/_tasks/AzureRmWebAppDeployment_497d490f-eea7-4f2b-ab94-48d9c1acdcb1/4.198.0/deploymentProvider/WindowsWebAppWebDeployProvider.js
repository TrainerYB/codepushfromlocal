    ...
    DeployWebAppStep() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (deployUtility.canUseWebDeploy(this.taskParams.UseWebDeploy)) {
                ...
                var msDeployPublishingProfile = yield this.appServiceUtility.getWebDeployPublishingProfile();
                yield WebDeployUtility_1.WebDeployUtility.publishUsingWebDeploy(this.taskParams, WebDeployUtility_1.WebDeployUtility.constructWebDeployArguments(this.taskParams, msDeployPublishingProfile), this.appServiceUtility);
            }
            else {
